...
public class ApiPlansResourceTest extends AbstractResourceTest {
    ...
    class ListPlans {
        ...
        public void should_return_empty_page_if_no_plans() {
            ...
            assertThat(response)
                .hasStatus(OK_200)
                .readEntity(PlansResponse.class)
    ...
    class Get {
        ...
        public void should_return_v4_plan() {
            ...
            assertThat(response).hasStatus(OK_200).readEntity(PlanV4.class).isEqualTo(PlanMapper.INSTANCE.map(planEntity));
        }
